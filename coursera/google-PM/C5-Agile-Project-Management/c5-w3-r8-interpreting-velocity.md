...
![Do: Be careful when sharing velocity with external stakeholders](./images/c5-w3-r8.1.png)
...
![Don't: Use velocity as a performance metric](./images/c5-w3-r8.2.png)
...
![Don't: Use velocity as a comparison metric](./images/c5-w3-r8.3.png)
...
![Do: proceed with caution when using velocity as a metric for project delivery date](./images/c5-w3-r8.4.png)
