...
1. Rating potential matches based on adopters

1. Allowing user to contact the adoption center

[Image of a phone application that has an image of pets and a call-to-action of "Adopt me"](./images/c5-w3-r6.png)
...
1. Will it bring value and does it meet quality measures? Has it been well-tested? 

1. Is it usable by the end user? Can we use their direct or indirect feedback to improve future versions of the product?
